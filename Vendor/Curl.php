 ...
 * Curl
 * 
 * @license    https://github.com/php-curl-class/php-curl-class/blob/master/LICENSE
 * @link       https://github.com/php-curl-class/php-curl-class
 */
class Curl
{
    const USER_AGENT = 'Mozilla/4.0 (compatible; MSIE 6.0; Windows NT 5.0; en) Opera 8.0';
    ...
    function setProxy($proxy, $port = 8080) {
